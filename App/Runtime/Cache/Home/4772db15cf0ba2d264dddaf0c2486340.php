...
<body>
	...
	<div class="container">
		...
		<div class="right">
<form id="user_info" action="<?php echo U('User/doalt');?>" method="post">
	<div class="item">
	...
	<input type="text" id="user_email" onblur="checkEmail()" name="email" value="<?php echo ($data['email']); ?>"/>
	</div>
	<div class="item">
		<label for="user_qq">
		<div class="user-input">
...
<script type="text/javascript">
	function checkEmail(){
		...
		$.get('<?php echo U('User/checkemail');?>',{'email':val,'id':id},function(data){
			if (data==1) {
				return true;
			}else{
