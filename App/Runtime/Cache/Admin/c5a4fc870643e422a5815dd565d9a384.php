...
<body>
	...
	<div class="adduser-wrapper">
		...
		<div class="info">
			...
			<br />
			你可以在本版块查看用户详细信息、修改用户信息。
		</div>
	</div>
	<div class="adduser-contents">
		<p class="title">添加用户</p>
		<div class="info">
			<form class="adduser-form" id="adduserForm" action="<?php echo U('User/doalteruser',array('id'=>$data['id']));?>" method="post" >
			<div class="adduser-item">
				...
				<input type="text" name="username" readonly value="<?php echo ($data['username']); ?>" />
			</div>
			<div class="adduser-item">
				<label for="user_name">
					<div class="adduser-info">
				...
				<input type="text" id="user_name" value="<?php echo ($data['name']); ?>" name="user_name" placeholder="客户姓名至少为两个字符" />
			</div>
			<div class="adduser-item">
				...
				<input type="text" name="companyname" value="<?php echo ($data['companyname']); ?>" id="user_comname" />
			</div>
			<div class="adduser-item">
				...
				<input type="text" name="companyphone" value="<?php echo ($data['companyphone']); ?>" id="user_comphone" />
			</div>
			<div class="adduser-item">
				...
				<input type="text" name="address" value="<?php echo ($data['address']); ?>" id="user_address" />
			</div>
			<div class="adduser-item">
				...
				<input type="text" value="<?php echo ($data['selfphone']); ?>" id="user_phone" name="user_phone" />
			</div>
			<div class="adduser-item">
				...
				<input type="text" id="user_email" value="<?php echo ($data['email']); ?>" name="user_email" />
			</div>
			<div class="adduser-item">
				<label for="user_qq">
					<div class="adduser-info">
				...
				<input type="text" name="qq" value="<?php echo ($data['qq']); ?>" id="user_qq" />
			</div>
			<div class="adduser-item">
